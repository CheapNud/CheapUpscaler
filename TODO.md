...
- [x] (2026-08-04 → 2026-08-04) Pipeline process lifecycle hardening in Core [audit]
...
- [x] (2026-08-04 → 2026-08-04) Worker API trust boundary for remote clients [audit]
...
- [x] (2026-08-04 → 2026-08-04) Platform registration by TFM instead of runtime OS [audit]
...
- [x] (2026-08-04 → 2026-08-04) Fix invalid MudBlazor parameters flagged by MUD0002 [audit]
